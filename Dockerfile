...
RUN curl -L https://github.com/yayoimizuha/hp_face_recognizer/archive/refs/heads/master.tar.gz | tar xzf - && mv hp_face_recognizer-master/* . && rm -rf hp_face_recognizer-master
